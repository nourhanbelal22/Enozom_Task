...
namespace LibraryDAL.Migrations
{
    ...
    [Migration("20240627141416_UpdateSeed")]
            ...
            modelBuilder.Entity("LibraryDAL.Entities.StudentBookCopy", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CopyId = 3,
                            StudentId = 1,
                            borrowedDate = new DateTime(2024, 6, 22, 17, 14, 15, 766, DateTimeKind.Local).AddTicks(6315),
                            expectedReturnDate = new DateTime(2024, 7, 7, 17, 14, 15, 766, DateTimeKind.Local).AddTicks(6385)
                        });
                });
